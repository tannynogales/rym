...
(function ($) {
		...
		$.getJSON('http://mindicador.cl/api', function(data) {
			...
			$("#uf").html(addCommas(dailyIndicators.uf.valor));
			$("#dolar").html(addCommas(dailyIndicators.dolar.valor));
			$("#euro").html(addCommas(dailyIndicators.euro.valor));
			$("#utm").html(addCommas(dailyIndicators.utm.valor));
		}).fail(function() {
